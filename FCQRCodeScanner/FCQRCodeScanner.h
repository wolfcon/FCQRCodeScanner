 ...
 */
+ (instancetype)scannerWithFrame:(CGRect)frame completion:(void (^)(NSString *codeString, FCQRCodeScanner *instance))completion dismissedAction:(void (^)(FCQRCodeScanner *instance))dismissedAction NS_AVAILABLE_IOS(7_0);
